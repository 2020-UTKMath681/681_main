'''
Details on this model can be found in:
Battista, N.A., Pearcy, L.B., Strickland, W.C. (2019). Modeling the prescription
opioid epidemic, Bulletin of Mathematical Biology, 81(7), 2258-2289.
'''
...
### For brevity in this example, assume everything below here is constant/known ###
...
def plot_solution(S,P,A,R,tstart=tstart,tstop=tstop,show=True):
    '''Plot a solution set and either show it or return the plot object for
    further tinkering'''
